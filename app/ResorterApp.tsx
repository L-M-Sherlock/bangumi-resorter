  ...
  async function openSession(sessionId: string, target: "compare" | "results" | "analysis" = "compare") {
    ...
    try {
      ...
      const reusableForecastModel = bundle.model?.version === bundle.session.modelVersion
        ...
        && bundle.model.diagnostics.forecast?.method === "posterior-contraction-mc-v13"
        && STOPPING_MODE_ORDER.every((mode) => bundle.model?.diagnostics?.forecasts?.[mode]?.method === "posterior-contraction-mc-v13")
