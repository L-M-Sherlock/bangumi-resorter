    ...
    <div className="principles-layout">
      ...
      <article className="principles-article">
        ...
        <section>
          ...
          <p>升级或按标签派生会话时，系统只复制新范围内仍然有效的比较，并记录其来源，防止父子会话把同一判断重复计算。新增作品从当前原评分先验开始，再由覆盖探索接入排序。<Term term="history-reuse">历史判断复用</Term>可以节省工作，但跨快照复用越多，也越可能把旧偏好当成今天的偏好；因此默认只复用同一快照。</p>
        </section>
