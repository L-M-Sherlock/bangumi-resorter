    ...
    <div className="principles-layout">
      ...
      <article className="principles-article">
        ...
        <section>
          ...
          <p>新建、升级或按标签派生会话时，系统只在创建瞬间复制目标范围内仍然有效的比较，并记录直接来源和原始根判断。副本属于新会话自身，来源之后新增、删除或被整体删除都不会回流成第二份证据；重复导入按根判断幂等。<Term term="history-reuse">历史判断导入</Term>可以节省工作，但跨快照导入越多，也越可能把旧偏好当成今天的偏好，因此新会话默认从零开始。</p>
        </section>
        ...
        <section>
          ...
          <ul className="principles-limitations">
            ...
            <li>Laplace 后验和未来证据收缩都是近似。页面上的概率与题量区间只在模型内部成立。</li>
